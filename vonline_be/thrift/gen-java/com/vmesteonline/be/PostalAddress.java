...
public class PostalAddress implements org.apache.thrift.TBase<PostalAddress, PostalAddress._Fields>, java.io.Serializable, Cloneable, Comparable<PostalAddress> {
  ...
  public int hashCode() {
    ...
    list.add(present_building);
    if (present_building)
      list.add(building);

    boolean present_staircase = true;
    list.add(present_staircase);
    if (present_staircase)
      list.add(staircase);
    ...
    boolean present_flatNo = true;
    list.add(present_flatNo);
    if (present_flatNo)
      list.add(flatNo);
