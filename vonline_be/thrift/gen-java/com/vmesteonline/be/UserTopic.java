...
public class UserTopic implements org.apache.thrift.TBase<UserTopic, UserTopic._Fields>, java.io.Serializable, Cloneable, Comparable<UserTopic> {
  ...
  public int hashCode() {
    ...
    boolean present_archieved = true;
    list.add(present_archieved);
    if (present_archieved)
      list.add(archieved);
    ...
    boolean present_notIntrested = true;
    list.add(present_notIntrested);
    if (present_notIntrested)
      list.add(notIntrested);

    boolean present_lastReadMessageId = true;
    list.add(present_lastReadMessageId);
    if (present_lastReadMessageId)
      list.add(lastReadMessageId);

    boolean present_lastWroteMeessgeId = true;
    list.add(present_lastWroteMeessgeId);
    if (present_lastWroteMeessgeId)
      list.add(lastWroteMeessgeId);
