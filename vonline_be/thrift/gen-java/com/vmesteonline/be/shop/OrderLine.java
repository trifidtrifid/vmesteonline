...
public class OrderLine implements org.apache.thrift.TBase<OrderLine, OrderLine._Fields>, java.io.Serializable, Cloneable, Comparable<OrderLine> {
  ...
  public int hashCode() {
    ...
    boolean present_quontity = true;
    list.add(present_quontity);
    if (present_quontity)
      list.add(quontity);

    boolean present_priceType = true && (isSetPriceType());
    list.add(present_priceType);
    if (present_priceType)
      list.add(priceType.getValue());
