...
public class ProductCategory implements org.apache.thrift.TBase<ProductCategory, ProductCategory._Fields>, java.io.Serializable, Cloneable, Comparable<ProductCategory> {
  ...
  private static final org.apache.thrift.protocol.TField LOGO_URLSET_FIELD_DESC = new org.apache.thrift.protocol.TField("logoURLset", org.apache.thrift.protocol.TType.SET, (short)5);
  ...
  public Set<ByteBuffer> logoURLset; // required
  ...
  public ProductCategory(ProductCategory other) {
    ...
    if (other.isSetLogoURLset()) {
      Set<ByteBuffer> __this__logoURLset = new HashSet<ByteBuffer>(other.logoURLset);
  ...
  public java.util.Iterator<ByteBuffer> getLogoURLsetIterator() {
    return (this.logoURLset == null) ? null : this.logoURLset.iterator();
  }

  public void addToLogoURLset(ByteBuffer elem) {
    if (this.logoURLset == null) {
      this.logoURLset = new HashSet<ByteBuffer>();
    }
    this.logoURLset.add(elem);
  }

  public Set<ByteBuffer> getLogoURLset() {
    return this.logoURLset;
  }

  public ProductCategory setLogoURLset(Set<ByteBuffer> logoURLset) {
    this.logoURLset = logoURLset;
    return this;
  }
  ...
  public ProductCategory setTopicSet(Set<Long> topicSet) {
    this.topicSet = topicSet;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LOGO_URLSET:
      if (value == null) {
        ...
        setLogoURLset((Set<ByteBuffer>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_descr = true && (isSetDescr());
    list.add(present_descr);
    if (present_descr)
      list.add(descr);

    boolean present_logoURLset = true && (isSetLogoURLset());
    list.add(present_logoURLset);
    if (present_logoURLset)
      list.add(logoURLset);

    boolean present_topicSet = true && (isSetTopicSet());
    list.add(present_topicSet);
    if (present_topicSet)
      list.add(topicSet);
