...
public class FullProductInto implements org.apache.thrift.TBase<FullProductInto, FullProductInto._Fields>, java.io.Serializable, Cloneable, Comparable<FullProductInto> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FullProductInto");
  ...
  static {
    schemes.put(StandardScheme.class, new FullProductIntoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FullProductIntoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FullProductInto.class, metaDataMap);
  }

  public FullProductInto() {
  }
   ...
   */
  public FullProductInto(FullProductInto other) {
  ...
  public FullProductInto deepCopy() {
    return new FullProductInto(this);
  }
  ...
  public FullProductInto setProduct(Product product) {
    this.product = product;
    return this;
  }
  ...
  public FullProductInto setDetails(ProductDetails details) {
    this.details = details;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FullProductInto)
      return this.equals((FullProductInto)that);
    return false;
  }

  public boolean equals(FullProductInto that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FullProductInto other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FullProductInto(");
    boolean first = true;
  ...
  private static class FullProductIntoStandardSchemeFactory implements SchemeFactory {
    public FullProductIntoStandardScheme getScheme() {
      return new FullProductIntoStandardScheme();
    }
  }

  private static class FullProductIntoStandardScheme extends StandardScheme<FullProductInto> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FullProductInto struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FullProductInto struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FullProductIntoTupleSchemeFactory implements SchemeFactory {
    public FullProductIntoTupleScheme getScheme() {
      return new FullProductIntoTupleScheme();
    }
  }

  private static class FullProductIntoTupleScheme extends TupleScheme<FullProductInto> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FullProductInto struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FullProductInto struct) throws org.apache.thrift.TException {
