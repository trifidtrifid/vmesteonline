...
public class ProductDetails implements org.apache.thrift.TBase<ProductDetails, ProductDetails._Fields>, java.io.Serializable, Cloneable, Comparable<ProductDetails> {
  ...
  public int hashCode() {
    ...
    boolean present_fullDescr = true && (isSetFullDescr());
    list.add(present_fullDescr);
    if (present_fullDescr)
      list.add(fullDescr);

    boolean present_imagesURLset = true && (isSetImagesURLset());
    list.add(present_imagesURLset);
    if (present_imagesURLset)
      list.add(imagesURLset);

    boolean present_pricesMap = true && (isSetPricesMap());
    list.add(present_pricesMap);
    if (present_pricesMap)
      list.add(pricesMap);

    boolean present_optionsMap = true && (isSetOptionsMap());
    list.add(present_optionsMap);
    if (present_optionsMap)
      list.add(optionsMap);
