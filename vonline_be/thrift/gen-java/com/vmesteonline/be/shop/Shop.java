...
public class Shop implements org.apache.thrift.TBase<Shop, Shop._Fields>, java.io.Serializable, Cloneable, Comparable<Shop> {
  ...
  public int hashCode() {
    ...
    boolean present_deliveryCosts = true && (isSetDeliveryCosts());
    list.add(present_deliveryCosts);
    if (present_deliveryCosts)
      list.add(deliveryCosts);

    boolean present_paymentTypes = true && (isSetPaymentTypes());
    list.add(present_paymentTypes);
    if (present_paymentTypes)
