...
public class FullAddressCatalogue implements org.apache.thrift.TBase<FullAddressCatalogue, FullAddressCatalogue._Fields>, java.io.Serializable, Cloneable, Comparable<FullAddressCatalogue> {
  ...
  public Set<com.vmesteonline.be.Country> countries; // required
  public List<com.vmesteonline.be.City> cities; // required
  public List<com.vmesteonline.be.Street> streets; // required
  public List<com.vmesteonline.be.Building> buildings; // required
  ...
  public FullAddressCatalogue(
    Set<com.vmesteonline.be.Country> countries,
    List<com.vmesteonline.be.City> cities,
    List<com.vmesteonline.be.Street> streets,
    List<com.vmesteonline.be.Building> buildings)
  {
    this();
  ...
  public FullAddressCatalogue(FullAddressCatalogue other) {
    if (other.isSetCountries()) {
      Set<com.vmesteonline.be.Country> __this__countries = new HashSet<com.vmesteonline.be.Country>(other.countries.size());
      for (com.vmesteonline.be.Country other_element : other.countries) {
        __this__countries.add(new com.vmesteonline.be.Country(other_element));
      }
      this.countries = __this__countries;
    }
    if (other.isSetCities()) {
      List<com.vmesteonline.be.City> __this__cities = new ArrayList<com.vmesteonline.be.City>(other.cities.size());
      for (com.vmesteonline.be.City other_element : other.cities) {
        __this__cities.add(new com.vmesteonline.be.City(other_element));
      }
      this.cities = __this__cities;
    }
    if (other.isSetStreets()) {
      List<com.vmesteonline.be.Street> __this__streets = new ArrayList<com.vmesteonline.be.Street>(other.streets.size());
      for (com.vmesteonline.be.Street other_element : other.streets) {
        __this__streets.add(new com.vmesteonline.be.Street(other_element));
      }
      this.streets = __this__streets;
    }
    if (other.isSetBuildings()) {
      List<com.vmesteonline.be.Building> __this__buildings = new ArrayList<com.vmesteonline.be.Building>(other.buildings.size());
      for (com.vmesteonline.be.Building other_element : other.buildings) {
        __this__buildings.add(new com.vmesteonline.be.Building(other_element));
      }
  ...
  public java.util.Iterator<com.vmesteonline.be.Country> getCountriesIterator() {
    return (this.countries == null) ? null : this.countries.iterator();
  }

  public void addToCountries(com.vmesteonline.be.Country elem) {
    if (this.countries == null) {
      this.countries = new HashSet<com.vmesteonline.be.Country>();
    }
    this.countries.add(elem);
  }

  public Set<com.vmesteonline.be.Country> getCountries() {
    return this.countries;
  }

  public FullAddressCatalogue setCountries(Set<com.vmesteonline.be.Country> countries) {
    this.countries = countries;
    return this;
  }
  ...
  public java.util.Iterator<com.vmesteonline.be.City> getCitiesIterator() {
    return (this.cities == null) ? null : this.cities.iterator();
  }

  public void addToCities(com.vmesteonline.be.City elem) {
    if (this.cities == null) {
      this.cities = new ArrayList<com.vmesteonline.be.City>();
    }
    this.cities.add(elem);
  }

  public List<com.vmesteonline.be.City> getCities() {
    return this.cities;
  }

  public FullAddressCatalogue setCities(List<com.vmesteonline.be.City> cities) {
    this.cities = cities;
    return this;
  }
  ...
  public java.util.Iterator<com.vmesteonline.be.Street> getStreetsIterator() {
    return (this.streets == null) ? null : this.streets.iterator();
  }

  public void addToStreets(com.vmesteonline.be.Street elem) {
    if (this.streets == null) {
      this.streets = new ArrayList<com.vmesteonline.be.Street>();
    }
    this.streets.add(elem);
  }

  public List<com.vmesteonline.be.Street> getStreets() {
    return this.streets;
  }

  public FullAddressCatalogue setStreets(List<com.vmesteonline.be.Street> streets) {
    this.streets = streets;
    return this;
  }
  ...
  public java.util.Iterator<com.vmesteonline.be.Building> getBuildingsIterator() {
    return (this.buildings == null) ? null : this.buildings.iterator();
  }

  public void addToBuildings(com.vmesteonline.be.Building elem) {
    if (this.buildings == null) {
      this.buildings = new ArrayList<com.vmesteonline.be.Building>();
    }
    this.buildings.add(elem);
  }

  public List<com.vmesteonline.be.Building> getBuildings() {
    return this.buildings;
  }

  public FullAddressCatalogue setBuildings(List<com.vmesteonline.be.Building> buildings) {
    this.buildings = buildings;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COUNTRIES:
      if (value == null) {
        ...
        setCountries((Set<com.vmesteonline.be.Country>)value);
      }
      break;
    ...
    case CITIES:
      if (value == null) {
        ...
        setCities((List<com.vmesteonline.be.City>)value);
      }
      break;
    ...
    case STREETS:
      if (value == null) {
        ...
        setStreets((List<com.vmesteonline.be.Street>)value);
      }
      break;
    ...
    case BUILDINGS:
      if (value == null) {
        ...
        setBuildings((List<com.vmesteonline.be.Building>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_streets = true && (isSetStreets());
    list.add(present_streets);
    if (present_streets)
      list.add(streets);

    boolean present_buildings = true && (isSetBuildings());
    list.add(present_buildings);
    if (present_buildings)
      list.add(buildings);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.countries = new HashSet<com.vmesteonline.be.Country>(2*_set0.size);
                for (int _i1 = 0; _i1 < _set0.size; ++_i1)
                {
                  com.vmesteonline.be.Country _elem2;
                  _elem2 = new com.vmesteonline.be.Country();
                  _elem2.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cities = new ArrayList<com.vmesteonline.be.City>(_list3.size);
                for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                {
                  com.vmesteonline.be.City _elem5;
                  _elem5 = new com.vmesteonline.be.City();
                  _elem5.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.streets = new ArrayList<com.vmesteonline.be.Street>(_list6.size);
                for (int _i7 = 0; _i7 < _list6.size; ++_i7)
                {
                  com.vmesteonline.be.Street _elem8;
                  _elem8 = new com.vmesteonline.be.Street();
                  _elem8.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buildings = new ArrayList<com.vmesteonline.be.Building>(_list9.size);
                for (int _i10 = 0; _i10 < _list9.size; ++_i10)
                {
                  com.vmesteonline.be.Building _elem11;
                  _elem11 = new com.vmesteonline.be.Building();
                  _elem11.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FullAddressCatalogue struct) throws org.apache.thrift.TException {
      ...
      if (struct.countries != null) {
        oprot.writeFieldBegin(COUNTRIES_FIELD_DESC);
        {
          ...
          for (com.vmesteonline.be.Country _iter12 : struct.countries)
          {
            _iter12.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.cities != null) {
        oprot.writeFieldBegin(CITIES_FIELD_DESC);
        {
          ...
          for (com.vmesteonline.be.City _iter13 : struct.cities)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.streets != null) {
        oprot.writeFieldBegin(STREETS_FIELD_DESC);
        {
          ...
          for (com.vmesteonline.be.Street _iter14 : struct.streets)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.buildings != null) {
        oprot.writeFieldBegin(BUILDINGS_FIELD_DESC);
        {
          ...
          for (com.vmesteonline.be.Building _iter15 : struct.buildings)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetCountries()) {
        {
          ...
          for (com.vmesteonline.be.Country _iter16 : struct.countries)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetCities()) {
        {
          ...
          for (com.vmesteonline.be.City _iter17 : struct.cities)
          {
            _iter17.write(oprot);
          }
        }
      ...
      if (struct.isSetStreets()) {
        {
          ...
          for (com.vmesteonline.be.Street _iter18 : struct.streets)
          {
            _iter18.write(oprot);
          }
        }
      ...
      if (struct.isSetBuildings()) {
        {
          ...
          for (com.vmesteonline.be.Building _iter19 : struct.buildings)
          {
            _iter19.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.countries = new HashSet<com.vmesteonline.be.Country>(2*_set20.size);
          for (int _i21 = 0; _i21 < _set20.size; ++_i21)
          {
            com.vmesteonline.be.Country _elem22;
            _elem22 = new com.vmesteonline.be.Country();
            _elem22.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.cities = new ArrayList<com.vmesteonline.be.City>(_list23.size);
          for (int _i24 = 0; _i24 < _list23.size; ++_i24)
          {
            com.vmesteonline.be.City _elem25;
            _elem25 = new com.vmesteonline.be.City();
            _elem25.read(iprot);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.streets = new ArrayList<com.vmesteonline.be.Street>(_list26.size);
          for (int _i27 = 0; _i27 < _list26.size; ++_i27)
          {
            com.vmesteonline.be.Street _elem28;
            _elem28 = new com.vmesteonline.be.Street();
            _elem28.read(iprot);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.buildings = new ArrayList<com.vmesteonline.be.Building>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            com.vmesteonline.be.Building _elem31;
            _elem31 = new com.vmesteonline.be.Building();
            _elem31.read(iprot);
