...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  private static final _Fields optionals[] = {_Fields.RECIPIENT_ID,_Fields.APPROVED_BY};
  ...
  public int hashCode() {
    ...
    boolean present_recipientId = true && (isSetRecipientId());
    list.add(present_recipientId);
    if (present_recipientId)
      list.add(recipientId);

    boolean present_created = true;
    list.add(present_created);
    if (present_created)
      list.add(created);

    boolean present_edited = true;
    list.add(present_edited);
    if (present_edited)
      list.add(edited);

    boolean present_approvedBy = true && (isSetApprovedBy());
    list.add(present_approvedBy);
