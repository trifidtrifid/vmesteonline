...
public class MessageService {
  ...
  public interface Iface {
     ...
     * @param recipientId
     */
    public Message createMessage(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId) throws com.vmesteonline.be.InvalidOperation, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void createMessage(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Message createMessage(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId) throws com.vmesteonline.be.InvalidOperation, org.apache.thrift.TException
    {
      send_createMessage(parentId, groupId, type, content, linkedMessages, tags, recipientId);
      return recv_createMessage();
    }

    public void send_createMessage(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void createMessage(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      createMessage_call method_call = new createMessage_call(parentId, groupId, type, content, linkedMessages, tags, recipientId, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class createMessage_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public createMessage_call(long parentId, long groupId, MessageType type, String content, Map<MessageType,Long> linkedMessages, Map<Long,String> tags, long recipientId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class createMessage<I extends Iface> extends org.apache.thrift.ProcessFunction<I, createMessage_args> {
      ...
      public createMessage_result getResult(I iface, createMessage_args args) throws org.apache.thrift.TException {
        createMessage_result result = new createMessage_result();
        try {
          result.success = iface.createMessage(args.parentId, args.groupId, args.type, args.content, args.linkedMessages, args.tags, args.recipientId);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class createMessage<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, createMessage_args, Message> {
      ...
      public void start(I iface, createMessage_args args, org.apache.thrift.async.AsyncMethodCallback<Message> resultHandler) throws TException {
        iface.createMessage(args.parentId, args.groupId, args.type, args.content, args.linkedMessages, args.tags, args.recipientId,resultHandler);
      }
    }
  ...
  public static class createMessage_args implements org.apache.thrift.TBase<createMessage_args, createMessage_args._Fields>, java.io.Serializable, Cloneable, Comparable<createMessage_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_linkedMessages = true && (isSetLinkedMessages());
      list.add(present_linkedMessages);
      if (present_linkedMessages)
        list.add(linkedMessages);
      ...
      boolean present_recipientId = true;
      list.add(present_recipientId);
      if (present_recipientId)
  ...
  public static class createTopic_args implements org.apache.thrift.TBase<createTopic_args, createTopic_args._Fields>, java.io.Serializable, Cloneable, Comparable<createTopic_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_rubricId = true;
      list.add(present_rubricId);
      if (present_rubricId)
        list.add(rubricId);

      boolean present_communityId = true;
      list.add(present_communityId);
      if (present_communityId)
  ...
  public static class checkUpdates_args implements org.apache.thrift.TBase<checkUpdates_args, checkUpdates_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkUpdates_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_lastResposeTimestamp = true;
      list.add(present_lastResposeTimestamp);
      if (present_lastResposeTimestamp)
        list.add(lastResposeTimestamp);
...
;
  ...
  public static class getTopics_args implements org.apache.thrift.TBase<getTopics_args, getTopics_args._Fields>, java.io.Serializable, Cloneable, Comparable<getTopics_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_commmunityId = true;
      list.add(present_commmunityId);
      if (present_commmunityId)
        list.add(commmunityId);
  ...
  public static class markTopicUnintrested_args implements org.apache.thrift.TBase<markTopicUnintrested_args, markTopicUnintrested_args._Fields>, java.io.Serializable, Cloneable, Comparable<markTopicUnintrested_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_interested = true;
      list.add(present_interested);
      if (present_interested)
        list.add(interested);
  ...
  public static class makeMessageLinked_args implements org.apache.thrift.TBase<makeMessageLinked_args, makeMessageLinked_args._Fields>, java.io.Serializable, Cloneable, Comparable<makeMessageLinked_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_message1Id = true;
      list.add(present_message1Id);
      if (present_message1Id)
        list.add(message1Id);

      boolean present_message2Id = true;
      list.add(present_message2Id);
      if (present_message2Id)
        list.add(message2Id);
