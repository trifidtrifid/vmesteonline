...
public class Topic implements org.apache.thrift.TBase<Topic, Topic._Fields>, java.io.Serializable, Cloneable, Comparable<Topic> {
  ...
  private static final _Fields optionals[] = {_Fields.RUBRIC_ID,_Fields.COMMUNITY_ID};
  ...
  public int hashCode() {
    ...
    boolean present_messageNum = true;
    list.add(present_messageNum);
    if (present_messageNum)
      list.add(messageNum);

    boolean present_viewers = true;
    list.add(present_viewers);
    if (present_viewers)
      list.add(viewers);

    boolean present_usersNum = true;
    list.add(present_usersNum);
    if (present_usersNum)
      list.add(usersNum);
    ...
    boolean present_likesNum = true;
    list.add(present_likesNum);
    if (present_likesNum)
      list.add(likesNum);

    boolean present_unlikesNum = true;
    list.add(present_unlikesNum);
    if (present_unlikesNum)
      list.add(unlikesNum);

    boolean present_rubricId = true && (isSetRubricId());
    list.add(present_rubricId);
    if (present_rubricId)
      list.add(rubricId);

    boolean present_communityId = true && (isSetCommunityId());
    list.add(present_communityId);
    if (present_communityId)
      list.add(communityId);

    boolean present_usertTopic = true && (isSetUsertTopic());
    list.add(present_usertTopic);
    if (present_usertTopic)
      list.add(usertTopic);
