...
struct Group {
	1: i64 id,
	2: i64 locationId,
	3: i64 creatorId, //идентификатор создателя шруппы для пользовательских групп
...
struct Message {
	...
	8: i32 edited,
	9: optional i64 approved, // 'идентификатор пользователя промодерировавшего сообщение',
	10: string content, // 'содержание сообщения',
	11: i32 likes,
	12: i32 unlikes,
	13: i64 groupId,
	14: optional i64 idForum,
	15: optional i64 idShop	
	16: optional i64 idDialog,
	17: optional i64 idNews,
 } // 'сообщение';
...
struct Topic {
	...
	7: i32 likes, 
	8: i32 unlikes,
	9: optional i64 rubric, //ссылка на рубрику
}
...
struct RubricLocation {
	2: i64 id,
	3: optional i64 grouId,
	4: i32 subscribed,
