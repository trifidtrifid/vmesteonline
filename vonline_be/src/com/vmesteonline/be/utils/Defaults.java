...
public class Defaults {
	...
	static {
		...
		try {
			...
			for (VoGroup dg : new VoGroup[] { new VoGroup("Мой дом", 0, true), new VoGroup("Соседи", 200, true),
					new VoGroup("Пешая доступность", 2000, true), new VoGroup("Быстро Доехать", 5000, true) }) {
