...
//	private static Logger logger = Logger.getLogger(VoMessage.class);
	...
	@Persistent
	private long parentId; // 'идентификатор родительского сообщения, NULL для
							// корневого со',
	@Persistent
	...
	@Persistent
	private VoUser recipientId; // 'адресат задан только для личных сообщений,
								// иначе NULL',
	@Persistent
	...
	private int edited;
	@Persistent
	private VoUser approved; // 'идентификатор пользователя промодерировавшего
								// сообщение',
	@Persistent
