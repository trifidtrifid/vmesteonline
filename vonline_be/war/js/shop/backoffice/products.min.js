    ...
    function( $,thriftModule,boCommon){
        ...
        function initEdit(){
            ...
            function getCategoriesHtml(searchCategory){
                //var shopId = $('.backoffice.dynamic').attr('id');
                var categories;
                (allCategories) ? categories = allCategories : categories = thriftModule.client.getAllCategories(shopId);
                ...
                $('.edit-show-add').click(function(e){
                    ...
                    switch (currentPane){
                        case "edit-product" :
                            ...
                            boCommon.setDropdownWithoutOverFlow(tableSelector.find('.categories-dropdown'),tableSelector,84);
