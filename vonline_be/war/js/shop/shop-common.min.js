define(
    ...
    function( $ ,flexslider, thriftModule,basketModule,spinnerModule,categoryModule,ordersModule ){
        ...
        /*$('.datepicker-chooseDate').on('create',function(ev){
            alert('111 '));
        });*/

        //$('.datepicker-chooseDate').datepicker("setValue",new Date(nextDate.orderDate*1000));
        //$('.datepicker-chooseDate').datepicker('setValue','01-01-2014'));

        var t = $('.datepicker-chooseDate').datepicker('option','defaultDate');
        for(var p in t){
            //alert(p+" "+t[p]);
        }
        //alert($('.datepicker-chooseDate').datepicker("getDate"));

        //alert(new Date(nextDate.orderDate*1000));
        //alert($('.datepicker-chooseDate').datepicker('option','defaultDate'));
