define(
    ...
    function( $,thriftModule,spinnerModule,commonModule,searchModule,ordersModule ){
        ...
        function initChooseDatepicker(isNewOrder,orderId,dateObj){
            ...
            if(!isNewOrder){
                ...
                initUpdateOrder(isNewOrder,orderId);

            }else{
                initUpdateOrder(isNewOrder);
            }

        }

        function initUpdateOrder(isNewOrder,orderId){
