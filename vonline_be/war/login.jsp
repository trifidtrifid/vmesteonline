							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form>
											<fieldset>
												<a class="btn btn-sm no-border btn-primary width-100"
													href="https://oauth.vk.com/authorize?client_id=4429306&redirect_uri=https%3A%2F%2F1-dot-vmesteonline.appspot.com%2Foauth&scope=4194305&display=popup&v=5.21&state=vk">Войти через
													Вконтакте</a>
									...
									<div class="widget-main">
										...
										<form>
											<fieldset>
												...
												<label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="text" id="confirmCode" class="form-control" placeholder="Код подтверждения" />
														<i class="icon-key"></i>
												</span>
