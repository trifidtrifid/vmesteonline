										...
										<form>
											<fieldset>
												<a class="btn btn-sm no-border btn-primary width-100 btn-vk"
													href="https://oauth.vk.com/authorize?client_id=4463293&redirect_uri=https%3A%2F%2F3-dot-vmesteonline.appspot.com%2Foauth&scope=4194305&display=popup&v=5.21&state="> Войти через
													Вконтакте</a>
