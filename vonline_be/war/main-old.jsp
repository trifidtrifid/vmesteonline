...
<%
	...
	Topic currTopic = (Topic)Topics.topics.toArray()[0];
	//out.print(currTopic.id);
                    ...
                    <div class="dd dd-draghandle">
                        ...
                        <% for (Topic t : Topics.topics) { %>
                        	<li class="dd-item dd2-item topic-item" data-id="15">
                                ...
                                <% if (t.messageNum > 0) {%>
	                                <%                                	
	                                	MessageListPart Messages = messageService.getMessages(t.id,someGroupId.get(0).id,mesType,t.id,false,0,2);                                	
	                                %>
	                                <ol class="dd-list">
	                                <% for (Message m : Messages.messages) { %>
		                                <li class="dd-item dd2-item topic-item" data-id="17">
	                                    ...
	                                    <%                                	
		                                	MessageListPart Messages2 = messageService.getMessages(t.id,someGroupId.get(0).id,mesType,m.id,false,0,2);	                                	
		                                %>
		                                <% if (Messages2.messages.size() > 0) {%>
			                                <ol class="dd-list">
			                                	<% for (Message m2 : Messages2.messages) { %>
			                                	<li class="dd-item dd2-item topic-item" data-id="17">
				                                	<div class="dd2-content topic-descr answer-item widget-body">
			                                            <div class="widget-main">
			                                                <div class="topic-left">
			                                                ...
			                                                <div class="topic-right">
			                                                    <div class="message-author">
			                                                        <a class="fa fa-link fa-relations" href="#"></a>
			                                                        <a class="fa fa-sitemap" href="#"></a>
			                                                        <a href="#"><%= m2.authorId %></a>
			                                                    </div>
			                                                    <p class="alert "><%= m2.content %></p>
			                                                    <div class="likes">
			                                                        <div class="answer-date"><%= m2.created %></div>
			                                                        <a href="#" class="like-item like">
			                                                            <i class="fa fa-thumbs-o-up"></i>
			                                                            <span><%= m2.likesNum %></span>
			                                                        </a>
			                                                        <a href="#" class="like-item dislike">
			                                                            <i class="fa fa-thumbs-o-down"></i>
			                                                            <span><%= m2.unlikesNum %></span>
			                                                        </a>
			                                                    </div>
			                                                </div>
			                                            </div>
