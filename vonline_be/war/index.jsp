	...
	<div id="main" class="wrapper">
		...
		<section id="content" class="wide-content">
			...
			<div class="grid_4">
				...
				<p/>
				<p align="center">Мы работаем напрямую с лучшими призводителями и доставляем продукцию к вам домой сразу, как только она приезжает к нам. Так мы обеспечиваем макисмальную свежесть. Часто вы получаете продукты прямо в день их производства!</p>
			</div>
			...
			<div class="grid_4">
				...
				<p/>
				<p align="center">Мы постоянно оптимизируем доставку, для того чтобы предложить Вам лучшие условия. Чем больше заказов поступает из одного дома - тем дешевле. Коопрерируйтесь с соседями и цена доставки будет
					уменьшаться!</p>
			</div>
