		...
		<div class="main-container" id="main-container">
			<div class="main-container-inner">
				...
				<p>ВместеОнлайн - это закрытая социальная сеть только для соседей. ВместеОнлайн - это самый простой и безопасный способ для Вас и Ваших соседей общаться онлайн и сделать Вашу реальную жизнь
					немного комфортней. Люди используют ВместеОнлайн для того чтобы:
				<ul>
					<li>получить отзыв о детском саде или школе по близости</li>
					<li>создать инициативную группу для решения проблеммы</li>
				...
				Используя современные технологии мы создаем добрососедские отношения!
				</p>
				...
				<h1>Приватность</h1>
				Онлайн приватность никогда не бывает лишней. На сайте ВместеОнлайн Вы можете обсуждать с соседями онлай все, что обсуждаете лично, встречаясь у лифта. <br> Мы гарантируем, что:
				<ul>
